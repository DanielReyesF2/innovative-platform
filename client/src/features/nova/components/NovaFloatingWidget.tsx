import { Bot, Lock, Mail, X } from "lucide-react";
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 flex flex-col rounded-lg border bg-background shadow-xl w-[380px] max-sm:bottom-0 max-sm:right-0 max-sm:w-full max-sm:rounded-none">
          ...
          <div className="flex flex-col items-center justify-center px-6 py-10 text-center">
            ...
            <h3 className="text-base font-semibold text-foreground mb-2">Funcionalidad Premium</h3>
            <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
              Nova AI es un asistente inteligente que analiza tus datos comerciales, genera reportes y responde
            ...
            <p className="text-[11px] text-muted-foreground mt-4">daniel@econova.com.mx</p>
          </div>
        </div>
      )}
