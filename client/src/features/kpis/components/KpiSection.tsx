...
import { KpiDetailModal, CreateKpiModal, CreateActionPlanModal } from "./modals";
...
export function KpiSection({ areaId: propAreaId, moduleSlug, compact }: KpiSectionProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {showCreateKpi && <CreateKpiModal categories={categories} onClose={() => setShowCreateKpi(false)} defaultAreaId={resolvedAreaId} />}
    </div>
  );
}
